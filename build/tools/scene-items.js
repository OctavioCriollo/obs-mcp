...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-scene-items", "Get a list of all scene items in a scene", {
    ...
    server.tool("obs-create-scene-item", "Create a scene item for a source in a scene", {
    ...
    server.tool("obs-remove-scene-item", "Remove a scene item from a scene", {
    ...
    server.tool("obs-set-scene-item-enabled", "Show or hide a scene item", {
    ...
    server.tool("obs-get-scene-item-transform", "Get the position, rotation, scale, or crop of a scene item", {
    ...
    server.tool("obs-set-scene-item-transform", "Set the position, rotation, scale, or crop of a scene item", {
        sceneName: z.string().describe("The scene the item is in"),
        sceneItemId: z.number().describe("The ID of the scene item"),
        ...
        try {
            ...
            if (transformParams.cropTop !== undefined || transformParams.cropBottom !== undefined ||
                ...
                if (transformParams.cropTop !== undefined)
                    sceneItemTransform.cropTop = transformParams.cropTop;
                if (transformParams.cropBottom !== undefined)
                    sceneItemTransform.cropBottom = transformParams.cropBottom;
                if (transformParams.cropLeft !== undefined)
                    sceneItemTransform.cropLeft = transformParams.cropLeft;
                if (transformParams.cropRight !== undefined)
                    sceneItemTransform.cropRight = transformParams.cropRight;
            }
    ...
    server.tool("obs-get-scene-item-id", "Get the ID of a scene item by its source name", {
