...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-filter-kind-list", "Gets an array of all available source filter kinds", {}, async () => {
        try {
    ...
    server.tool("obs-get-source-filter-list", "Gets an array of all of a source's filters", {
    ...
    server.tool("obs-get-filter-default-settings", "Gets the default settings for a filter kind", {
    ...
    server.tool("obs-create-source-filter", "Creates a new filter, adding it to the specified source", {
        ...
        try {
            const requestParams = { sourceName, filterName, filterKind };
    ...
    server.tool("obs-remove-source-filter", "Removes a filter from a source", {
    ...
    server.tool("obs-set-source-filter-name", "Sets the name of a source filter (rename)", {
        sourceName: z.string().describe("Name of the source the filter is on"),
    ...
    server.tool("obs-get-source-filter", "Gets the info for a specific source filter", {
        sourceName: z.string().describe("Name of the source"),
    ...
    server.tool("obs-set-source-filter-index", "Sets the index position of a filter on a source", {
        sourceName: z.string().describe("Name of the source the filter is on"),
        filterName: z.string().describe("Name of the filter"),
    ...
    server.tool("obs-set-source-filter-settings", "Sets the settings of a source filter", {
        sourceName: z.string().describe("Name of the source the filter is on"),
        ...
        try {
            const requestParams = { sourceName, filterName, filterSettings };
    ...
    server.tool("obs-set-source-filter-enabled", "Sets the enable state of a source filter", {
        sourceName: z.string().describe("Name of the source the filter is on"),
        filterName: z.string().describe("Name of the filter"),
