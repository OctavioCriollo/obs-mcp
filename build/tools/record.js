...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-record-status", "Gets the status of the record output", {}, async () => {
        try {
    ...
    // ToggleRecord tool
    server.tool("obs-toggle-record", "Toggles the status of the record output", {}, async () => {
        try {
    ...
    // StartRecord tool
    server.tool("obs-start-record", "Starts the record output", {}, async () => {
        try {
    ...
    // StopRecord tool
    server.tool("obs-stop-record", "Stops the record output", {}, async () => {
        try {
    ...
    server.tool("obs-toggle-record-pause", "Toggles pause on the record output", {}, async () => {
        try {
    ...
    // PauseRecord tool
    server.tool("obs-pause-record", "Pauses the record output", {}, async () => {
        try {
    ...
    // ResumeRecord tool
    server.tool("obs-resume-record", "Resumes the record output", {}, async () => {
        try {
    ...
    server.tool("obs-split-record-file", "Splits the current file being recorded into a new file", {}, async () => {
        try {
    ...
    server.tool("obs-create-record-chapter", "Adds a new chapter marker to the file currently being recorded", {
