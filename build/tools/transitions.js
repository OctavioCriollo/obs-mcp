...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-transition-list", "Get a list of available transitions in OBS", {}, async () => {
        try {
    ...
    server.tool("obs-get-current-transition", "Get the name of the currently active transition", {}, async () => {
        try {
    ...
    server.tool("obs-set-current-transition", "Set the current transition in OBS", {
    ...
    server.tool("obs-get-transition-duration", "Get the duration of the current transition in milliseconds", {}, async () => {
        try {
    ...
    server.tool("obs-set-transition-duration", "Set the duration of the current transition in milliseconds", {
    ...
    server.tool("obs-get-transition-kind", "Get the kind/type of the current transition", {}, async () => {
        try {
            const transition = await client.sendRequest("GetCurrentSceneTransition");
            return {
                content: [
    ...
    server.tool("obs-set-transition-settings", "Set the settings of the current transition", {
    ...
    server.tool("obs-get-transition-settings", "Get the settings of the current transition", {}, async () => {
        try {
    ...
    server.tool("obs-trigger-transition", "Trigger a scene transition in OBS (Studio Mode must be enabled)", {}, async () => {
        try {
