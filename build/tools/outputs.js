...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-virtual-cam-status", "Gets the status of the virtualcam output", {}, async () => {
        try {
    ...
    server.tool("obs-toggle-virtual-cam", "Toggles the state of the virtualcam output", {}, async () => {
        try {
    ...
    server.tool("obs-start-virtual-cam", "Starts the virtualcam output", {}, async () => {
        try {
    ...
    // StopVirtualCam tool
    server.tool("obs-stop-virtual-cam", "Stops the virtualcam output", {}, async () => {
        try {
    ...
    server.tool("obs-get-replay-buffer-status", "Gets the status of the replay buffer output", {}, async () => {
        try {
    ...
    server.tool("obs-toggle-replay-buffer", "Toggles the state of the replay buffer output", {}, async () => {
        try {
    ...
    server.tool("obs-start-replay-buffer", "Starts the replay buffer output", {}, async () => {
        try {
    ...
    server.tool("obs-stop-replay-buffer", "Stops the replay buffer output", {}, async () => {
        try {
    ...
    server.tool("obs-save-replay-buffer", "Saves the contents of the replay buffer output", {}, async () => {
        try {
    ...
    server.tool("obs-get-last-replay-buffer-replay", "Gets the filename of the last replay buffer save file", {}, async () => {
        try {
    ...
    // GetOutputList tool
    server.tool("obs-get-output-list", "Gets the list of available outputs", {}, async () => {
        try {
    ...
    server.tool("obs-get-output-status", "Gets the status of an output", {
    ...
    // ToggleOutput tool
    server.tool("obs-toggle-output", "Toggles the status of an output", {
        outputName: z.string().describe("Output name")
    }, async ({ outputName }) => {
        try {
    ...
    // StartOutput tool
    server.tool("obs-start-output", "Starts an output", {
        outputName: z.string().describe("Output name")
    }, async ({ outputName }) => {
        try {
    ...
    // StopOutput tool
    server.tool("obs-stop-output", "Stops an output", {
        outputName: z.string().describe("Output name")
    }, async ({ outputName }) => {
        try {
    ...
    server.tool("obs-get-output-settings", "Gets the settings of an output", {
        outputName: z.string().describe("Output name")
    }, async ({ outputName }) => {
        try {
    ...
    server.tool("obs-set-output-settings", "Sets the settings of an output", {
        outputName: z.string().describe("Output name"),
