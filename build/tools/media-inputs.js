...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-media-input-status", "Gets the status of a media input", {
    ...
    server.tool("obs-set-media-input-cursor", "Sets the cursor position of a media input", {
        inputName: z.string().describe("Name of the media input"),
    ...
    server.tool("obs-offset-media-input-cursor", "Offsets the current cursor position of a media input", {
        inputName: z.string().describe("Name of the media input"),
    ...
    server.tool("obs-trigger-media-input-action", "Triggers an action on a media input", {
        inputName: z.string().describe("Name of the media input"),
        mediaAction: z.enum([
