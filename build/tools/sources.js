...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-source-active", "Gets the active and show state of a source", {
    ...
    server.tool("obs-get-source-screenshot", "Gets a Base64-encoded screenshot of a source", {
    ...
    server.tool("obs-save-source-screenshot", "Saves a screenshot of a source to the filesystem", {
        sourceName: z.string().optional().describe("Name of the source to take a screenshot of"),
        sourceUuid: z.string().optional().describe("UUID of the source to take a screenshot of"),
        imageFormat: z.string().describe("Image compression format to use"),
