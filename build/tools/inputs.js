...
export async function initialize(server, client) {
    // GetInputList tool
    server.tool("obs-get-input-list", "Gets an array of all inputs in OBS", {
    ...
    server.tool("obs-get-input-kind-list", "Gets an array of all available input kinds in OBS", {
    ...
    server.tool("obs-get-special-inputs", "Gets the names of all special inputs", {}, async () => {
        try {
    ...
    // CreateInput tool
    server.tool("obs-create-input", "Creates a new input, adding it as a scene item to the specified scene", {
        ...
        try {
            const requestParams = { sceneName, inputName, inputKind };
    ...
    // RemoveInput tool
    server.tool("obs-remove-input", "Removes an existing input", {
    ...
    // SetInputName tool
    server.tool("obs-set-input-name", "Sets the name of an input (rename)", {
    ...
    server.tool("obs-get-input-default-settings", "Gets the default settings for an input kind", {
    ...
    server.tool("obs-get-input-settings", "Gets the settings of an input", {
    ...
    server.tool("obs-set-input-settings", "Sets the settings of an input", {
        ...
        try {
            const requestParams = { inputName, inputSettings };
    ...
    // GetInputMute tool
    server.tool("obs-get-input-mute", "Gets the audio mute state of an input", {
    ...
    // SetInputMute tool
    server.tool("obs-set-input-mute", "Sets the audio mute state of an input", {
    ...
    server.tool("obs-toggle-input-mute", "Toggles the audio mute state of an input", {
    ...
    // GetInputVolume tool
    server.tool("obs-get-input-volume", "Gets the current volume setting of an input", {
    ...
    // SetInputVolume tool
    server.tool("obs-set-input-volume", "Sets the volume setting of an input", {
    ...
    server.tool("obs-get-input-audio-balance", "Gets the audio balance of an input", {
    ...
    server.tool("obs-set-input-audio-balance", "Sets the audio balance of an input", {
    ...
    server.tool("obs-get-input-audio-sync-offset", "Gets the audio sync offset of an input", {
    ...
    server.tool("obs-set-input-audio-sync-offset", "Sets the audio sync offset of an input", {
    ...
    server.tool("obs-get-input-audio-monitor-type", "Gets the audio monitor type of an input", {
    ...
    server.tool("obs-set-input-audio-monitor-type", "Sets the audio monitor type of an input", {
