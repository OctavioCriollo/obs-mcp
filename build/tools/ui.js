...
export async function initialize(server, client) {
    ...
    server.tool("obs-get-studio-mode", "Gets whether studio mode is enabled", {}, async () => {
        try {
    ...
    server.tool("obs-set-studio-mode", "Enables or disables studio mode", {
    ...
    server.tool("obs-open-input-properties", "Opens the properties dialog of an input", {
    ...
    server.tool("obs-open-input-filters", "Opens the filters dialog of an input", {
        inputName: z.string().optional().describe("Name of the input to open the dialog of"),
        inputUuid: z.string().optional().describe("UUID of the input to open the dialog of")
    }, async ({ inputName, inputUuid }) => {
        try {
    ...
    server.tool("obs-open-input-interact", "Opens the interact dialog of an input", {
        inputName: z.string().optional().describe("Name of the input to open the dialog of"),
        inputUuid: z.string().optional().describe("UUID of the input to open the dialog of")
    }, async ({ inputName, inputUuid }) => {
        try {
    ...
    // GetMonitorList tool
    server.tool("obs-get-monitor-list", "Gets a list of connected monitors and information about them", {}, async () => {
        try {
    ...
    server.tool("obs-open-video-mix-projector", "Opens a projector for a specific output video mix", {
        videoMixType: z.enum([
        ...
        try {
            const requestParams = { videoMixType };
    ...
    server.tool("obs-open-source-projector", "Opens a projector for a source", {
