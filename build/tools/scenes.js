...
export async function initialize(server, client) {
    // GetSceneList tool
    server.tool("obs-get-scene-list", "Get a list of scenes in OBS", {}, async () => {
        try {
    ...
    server.tool("obs-get-current-scene", "Get the current active scene in OBS", {}, async () => {
        try {
    ...
    server.tool("obs-set-current-scene", "Set the current active scene in OBS", {
    ...
    server.tool("obs-get-preview-scene", "Get the current preview scene in OBS Studio Mode", {}, async () => {
        try {
    ...
    server.tool("obs-set-preview-scene", "Set the current preview scene in OBS Studio Mode", {
    ...
    // CreateScene tool
    server.tool("obs-create-scene", "Create a new scene in OBS", {
    ...
    // RemoveScene tool
    server.tool("obs-remove-scene", "Remove a scene from OBS", {
    ...
    server.tool("obs-trigger-studio-transition", "Trigger a transition from preview to program scene in Studio Mode", {}, async () => {
        try {
